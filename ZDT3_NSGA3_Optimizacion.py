...
for i in range (0,5):
    ...
    Archivo_Simulacion     = f"Simulacion_ZDT3_{Abreviatura[i]}.xlsx"
    Archivo_Semilla        = f"Semilla_ZDT3_{Abreviatura[i]}_VD.json"
    Nombre_Salida          = f"Salida_NSGAIII_ZDT3_{Abreviatura[i]}.xlsx"
    Nombre_Soluciones      = f"Soluciones_NSGAIII_ZDT3_{Abreviatura[i]}.xlsx"
    ...
    # El siguiente código Modela el Problema ZDT3 con restricción
    class MyProblemZDT3(ElementwiseProblem):
    ...
    Evaluator().eval(problemZDT3, Pop_Semilla)
...
Duraciones_Tabla.to_excel('DuracionesZDT3.xlsx',index=True)