...
for i in range (0,5):
    ...
    Archivo_Simulacion     = f"Simulacion_PRB1_{Abreviatura[i]}.xlsx"
    Archivo_Semilla        = f"Semilla_PRB1_{Abreviatura[i]}_VD.json"
    Nombre_Salida          = f"Salida_NSGAIII_PRB1_{Abreviatura[i]}.xlsx"
    Nombre_Soluciones      = f"Soluciones_NSGAIII_PRB1_{Abreviatura[i]}.xlsx"
    ...
    # El siguiente código Modela el Problema PRB1 con restricción
    ...
    Evaluator().eval(problemPRB1, Pop_Semilla)
...
Duraciones_Tabla.to_excel('DuracionesPRB1.xlsx',index=True)