...
for i in range (0,5):
    ...
    Nombre_Salida          = f"Salida_NSGAII_ZDT4_{Abreviatura[i]}.xlsx"
    Nombre_Soluciones      = f"Soluciones_NSGAII_ZDT4_{Abreviatura[i]}.xlsx"
...
Duraciones_Tabla.to_excel('DuracionesZDT4.xlsx',index=True)